...
class CityDirectoryExtractor:
    ...
    def __init__(self, detector, output_dir="extracted_columns"):
        ...
        self.LEFT_AD_THRESHOLD = 0.2  # 20% from left for advertisement detection
        self.TOP_THRESHOLD = 0.33     # 33% from top
    ...
    def detect_page_type(self, image_index):
        ...
        left_threshold = int(img_width * self.LEFT_AD_THRESHOLD)
    ...
    def _find_left_page_separators(self, img_height, img_width, vertical_lines, horizontal_lines):
        ...
        y_separators = self._find_horizontal_separators(horizontal_lines, img_height)
    ...
    def _find_right_page_separators(self, img_height, img_width, vertical_lines, horizontal_lines):
        ...
        # Right pages typically don't have left advertisements
        x_sep_left = 0
    ...
    def _find_leftmost_vertical_line(self, vertical_lines, threshold):
        """Find leftmost vertical line within threshold."""
        if vertical_lines is None or len(vertical_lines) == 0:
            return 0
    ...
    def _find_horizontal_separators(self, horizontal_lines, img_height):
        """Find top and bottom horizontal separators."""
        ...
        top_threshold = int(img_height * self.TOP_THRESHOLD)
        ...
        for line in horizontal_lines:
            ...
            if y < top_threshold and y > y_sep_top_left:
                y_sep_top_left = y
...
if __name__ == "__main__":
    ...
    IMAGE_PATHS = [
        'C:\\Users\\rangw\\Dropbox\\HouseNovel\\Application\\2_Phase_1-Trial_Project\\DirCity_Directory_Crop out with Key Lines\\test_images\\page_0272.jpg',
        'C:\\Users\\rangw\\Dropbox\\HouseNovel\\Application\\2_Phase_1-Trial_Project\\DirCity_Directory_Crop out with Key Lines\\test_images\\page_0273.jpg',     
    ]
